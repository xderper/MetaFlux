    ...
    <html lang="ru">
      ...
      >
        ...
        {process.env.NODE_ENV === 'production' && (
          <>
            {/* Google Analytics */}
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-SD8HK0W0EF"></script>
            <script dangerouslySetInnerHTML={{
              __html: `
                window.dataLayer = window.dataLayer || [];
                function gtag(){dataLayer.push(arguments);}
                gtag('js', new Date());
                gtag('config', 'G-SD8HK0W0EF');
              `
            }} />
            ...
            <script dangerouslySetInnerHTML={{
              __html: `
                ...
                })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=103441465', 'ym');
            ...
            <noscript>
              <div>
                <img src="https://mc.yandex.ru/watch/103441465" style={{ position: 'absolute', left: '-9999px' }} alt="" />
              </div>
            </noscript>
          </>
        )}
